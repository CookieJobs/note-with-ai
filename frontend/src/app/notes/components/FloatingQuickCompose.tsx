    ...
    >
      ...
      <div className={`${styles.floatingComposeShell} ${bouncing ? styles.floatingComposeBounce : ''}`}>
        {!open ? (
          ...
          <div
            className={`${styles.floatingComposeExpanded} ${editorFocused && (suggestLoading || suggestNotes.length > 0) ? styles.floatingComposeExpandedHasSuggest : styles.floatingComposeExpandedNoSuggest}`}
            ref={expandedRef}
          >
            ...
            <div className={`${styles.floatingComposeEditor} dark`}>
              <RichTextEditor
                value={valueJson}
                onChange={onChange}
